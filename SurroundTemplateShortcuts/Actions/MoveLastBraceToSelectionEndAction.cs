...
{
    [Action("SurroundTemplateShortcuts Move Closing Brace To Selection End", Id = 523601, VsShortcuts = new[] { "Control+Alt+0" }, IdeaShortcuts = new[] { "Control+Alt+0" },
        ShortcutScope = ShortcutScope.TextEditor)]
    public class SurroundTemplateShortcuts_MoveClosingBraceToSelectionEndAction : IExecutableAction
    {
